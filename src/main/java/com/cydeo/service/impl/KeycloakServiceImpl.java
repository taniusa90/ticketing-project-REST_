...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    @Override
    public Response userCreate(UserDTO userDTO) {//will create a user in Keycloak
        ...
        Keycloak keycloak = getKeycloakInstance();//if you want to do some actions in keycloak open a new instance
