...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, UserMapper userMapper, @Lazy ProjectService projectService, @Lazy TaskService taskService, @Lazy KeycloakService keycloakService) {
...
//    }
    ...
    public void delete(String username) throws TicketingProjectException {
        ...
        if (checkIfUserCanBeDeleted(user)) {
            ...
            throw new TicketingProjectException("User can not be deleted");//if the user can not be deleted
        }
